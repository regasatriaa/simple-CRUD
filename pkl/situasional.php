...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  <ul class="nav navbar-nav navbar-right">
    ...
    <li><a href="uploadsituasional.php">Upload</a>
    </li>
   ...
   // $no = 1;
    ...
    ?>
      ...
      <td><center><?php echo $data['DateUpload']; ?></center></td>
           		               ...
           		               <td align="center">        
                <a href="Hapussituasional.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data?')">Hapus</a>
            </td>
