...
<tr><td>
    <p>Jenis Laporan :</p></td>
                 <td><p>
                   ...
                   $q = mysql_query("select triwulan from laporantriwulan"); 
                   while ($row1 = mysql_fetch_array($q)){
                   echo "<option value=$row1[triwulan]>$row1[triwulan]</option>";
                   }
                   ?>
                   </td>
</tr>
...
<tr><td>
    <p>Periode  :</p></td>
                 <td><p>
                   ...
                   <?php include 'Koneksi.php';
                   $q = mysql_query("select periode from periodetriwulan"); 
                   while ($row1 = mysql_fetch_array($q)){
                   echo "<option value=$row1[periode]>$row1[periode]</option>";
                   }
                   ?>
                   </td>
</tr>
...
<tr>
    ...
    <a href="triwulan.php" ><input type="button" class="button" value="Batal"></a></td>
</tr>
</table>
</form>