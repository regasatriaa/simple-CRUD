...
<link href="bootstrap.min.css" rel="stylesheet"/>
 ...
 <div class="container" style="margin-top:35px">
  ...
  $query = "SELECT * FROM bulanan ORDER BY ID DESC";
  ...
  <td><a href="adminHapus.php?id=<?php echo $r['id'] ?>" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data?')">Hapus</a>
   </td>
   </tr>
