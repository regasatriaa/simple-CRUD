...
if(isset($_GET['id'])){
	...
	if(mysql_num_rows($cek) == 0){
		...
		if($del){
			...
			echo '<script language="javascript">alert("Data Berhasil Di Hapus"); document.location="admintriwulan.php";</script>';	//membuat Link untuk kembali ke halaman beranda
		}else{
			
			echo '<script language="javascript">alert("Data Gagal Di Hapus"); document.location="admintriwulan.php";</script>';	//membuat Link untuk kembali ke halaman beranda
