...
<div class="container" style="margin-top:35px">
  ...
  $query = "SELECT * FROM situasional ORDER BY ID DESC";
  ...
  <td><a href="adminHapussituasional.php?id=<?php echo $r['id'] ?>" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data?')">Hapus</a>
   </td>
   </tr>
