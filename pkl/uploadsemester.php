...
<tr><td>
    <p>Jenis Laporan :</p></td>
                 <td><p>
                   ...
                   $q = mysql_query("select semester from laporansemester"); 
...
<tr><td>
    <p>Periode  :</p></td>
                 <td><p>
                   ...
                   <?php include 'Koneksi.php';
                   $q = mysql_query("select semester from periodesemester"); 
                   while ($row1 = mysql_fetch_array($q)){
                   echo "<option value=$row1[semester]>$row1[semester]</option>";
                   }
                   ?>
...
<tr>
    ...
    <a href="semester.php" ><input type="button" class="button" value="Batal"></a></td>
</tr>
</table>
</form>