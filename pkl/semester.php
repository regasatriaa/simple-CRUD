...
$query = mysql_query("SELECT * FROM semester WHERE username = '$username'");
...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  <ul class="nav navbar-nav navbar-right">
    ...
    <li><a href="uploadsemester.php">Upload</a>
    </li>
   ...
   // $no = 1;
    ...
    ?>
     ...
     <td><?php echo $data['tahun']; ?></td>
		  <td><?php echo $data['DateUpload']; ?></td>
         		  
           		               <td align="center">                 
                <a href="Hapussemester.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data?')">Hapus</a>
            </td>
