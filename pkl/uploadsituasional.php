...
<tr>
    <td width="100" valign="top">Jenis Laporan</td>
    <td><textarea name="Detail" cols="30" rows="3" placeholder="Jenis Laporan" required></textarea></td>
</tr>
<tr>
...
<tr>
    ...
    <a href="situasional.php" ><input type="button" class="button" value="Batal"></a></td>
</tr>
</table>
</form>