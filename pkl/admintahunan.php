...
$query = mysql_query("SELECT * FROM tahunan WHERE username = '$username'");
...
<!--<h1 align="center"> Tabel Laporan Bulanan</h1>--> 
...
<div class="container" style="margin-top:35px">
  ...
  $query = "SELECT * FROM tahunan ORDER BY ID DESC";
  ...
  <td><a href="adminHapustahunan.php?id=<?php echo $r['id'] ?>" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data?')">Hapus</a>
   </td>
   </tr>
